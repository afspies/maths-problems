...
| [Square Peg conjecture](problems/square-peg/PROBLEM.md) | 🟡 partial results | Does every Jordan curve in the plane contain the four vertices of a nondegenerate square? | Finite-p-variation (p<2) and Dini-Young Jordan curves satisfy Asano-Ike's primitive criterion; explicit nonrectifiable non-locally-monotone double spirals get every rectangle | — |
