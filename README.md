...
| [Square Peg conjecture](problems/square-peg/PROBLEM.md) | 🟡 partial results | Does every Jordan curve in the plane contain the four vertices of a nondegenerate square? | New nonrectifiable p<2 and critical p=2 classes get every rectangle; an explicit null double spiral proves the Asano-Ike primitive criterion cannot cover all Jordan curves | — |
