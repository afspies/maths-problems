...
| [Four-dimensional Mahler volume conjecture](problems/mahler-volume-4d/PROBLEM.md) | 🟡 partial results | For every convex body K⊂R^4, prove \|K\| \|(K-s(K))°\| ≥ 3125/576, with equality only for simplices. | Sharp inequality for every 4D affine join; terminal non-simplices have quadratic rank ≥3 and at least 8 vertices; pair-terminal non-pyramids satisfy 2f03≥5(f0+f3)-4 and have ≥6 nonsimplicial facets. | — |
...
| [Square Peg conjecture](problems/square-peg/PROBLEM.md) | 🟡 partial results | Does every Jordan curve in the plane contain the four vertices of a nondegenerate square? | The null eye is arbitrarily torsion and has no positive-tau !/* ambiguity; the exact frontier is a Milnor/ephemeral diagonal class, while square envelopes obey an exact ribbon-area conservation law | — |
