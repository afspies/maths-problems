...
|---|---|---|---|---|
| [Four-dimensional Mahler volume conjecture](problems/mahler-volume-4d/PROBLEM.md) | 🟡 partial results | For every convex body K⊂R^4, prove \|K\| \|(K-s(K))°\| ≥ 3125/576, with equality only for simplices. | Sharp inequality for every 4D affine join; certified bi-centered connected pair-terminal 24-cell has trace <1/9; KKT/spanning lemmas reduce the connected case to a global facet-boundary inequality. | — |
