...
|---|---|---|---|---|
| [Four-dimensional Kakeya conjecture](problems/kakeya-r4/PROBLEM.md) | 🟡 partial results | Must every Kakeya set in R^4 have Hausdorff and Minkowski dimension 4? | Harmonic transverse-stack union theorem for an infinite ruled-quadric subclass, giving full Minkowski dimension there; no new general, sticky, or Hausdorff bound | — |
