...
| [Vizing’s domination conjecture](problems/vizing-domination/PROBLEM.md) | 🟡 partial results | Do all finite simple graphs satisfy γ(G □ H) ≥ γ(G)γ(H)? | K1/K3 terminal-capacity inequality; external-private and row hole-packing theorems; bidirectional blocker lift (constant still 0.5643) | — |
