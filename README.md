...
|---|---|---|---|---|
| [Four-dimensional Kakeya conjecture](problems/kakeya-r4/PROBLEM.md) | 🟡 partial results | Must every Kakeya set in R^4 have Hausdorff and Minkowski dimension 4? | Full Hausdorff dimension for fixed all-scale transverse and rank-two-separated parabolic stacks; parent-ancestry tangency lemma removes descendant Mdelta baseline, with no new general or sticky bound | — |
...
| [Square Peg conjecture](problems/square-peg/PROBLEM.md) | 🟡 partial results | Does every Jordan curve in the plane contain the four vertices of a nondegenerate square? | The exact frontier is GKS-specific boundary creation: fixed-input microlocal Hom fails on translated telescopes, cross-time envelopes allow alternating winding, and odd local square degree escapes through total collision | — |
