...
| [Vizing’s domination conjecture](problems/vizing-domination/PROBLEM.md) | 🟡 partial results | Do all finite simple graphs satisfy γ(G □ H) ≥ γ(G)γ(H)? | Exact fibre-slack identity; terminal odd-clique equality classification; full packing-hierarchy obstruction; fractional tensor bridge (constant still 0.5643) | — |
