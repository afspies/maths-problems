...
| [Vizing’s domination conjecture](problems/vizing-domination/PROBLEM.md) | 🟡 partial results | Do all finite simple graphs satisfy γ(G □ H) ≥ γ(G)γ(H)? | Corrected repair/overlap ledgers; adaptive provider Hall matching with labelled cycles and local cuts; escape/invariant no-gos (best constant still 0.5643) | — |
