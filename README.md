...
| [Vizing’s domination conjecture](problems/vizing-domination/PROBLEM.md) | 🟡 partial results | Do all finite simple graphs satisfy γ(G □ H) ≥ γ(G)γ(H)? | K1/K3 terminal structure; labelled escape cycles; typed fibre relaxation with c/2 baseline; exact connected zero-factor lift obstructions (best constant still 0.5643) | — |
