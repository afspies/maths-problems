# Handoff prompt — Conway's 99-graph problem
...
You are working on: Conway's 99-graph problem — Does srg(99,14,1,2) exist (every edge in a unique triangle, non-edge in a unique quad)?

Work in problems/conway-99-graph/ of the maths-problems repo. Read, in order:
1. /AGENTS.md (repo root) — session conventions: branch `problem/conway-99-graph/<date>-<topic>`,
...
2. problems/conway-99-graph/PROBLEM.md — statement, certificate/verifier spec, known
   structure, attack-angle menu.
3. problems/conway-99-graph/LEARNINGS.md — do what "next session should do first" says.
4. problems/conway-99-graph/JOURNAL.md — recent sessions' detail, if needed.
